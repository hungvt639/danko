                ...
                <div className={show ? "width-100 none-scroll" : "width-100"}>
                    <Switch>
                        ...
                        <Route
                            ...
                            component={() => (
                                <DatNenVinhYen setHash={setHash} />
                            )}
                        />
                        <Route
                            exact
                            path="/"
                            component={() => <Home setHash={setHash} />}
                        />
                        <Redirect to="/" />
                    </Switch>
                </div>
